...
# Control replicate 1
control_rep1 <- read_tsv("reads_per_gene/control_rep1_ReadsPerGene.out.tab", 
                           col_names = c("gene_id", "total", "antisense", "sense"), 
                           skip = 4) 
# Control replicate 3
control_rep3 <- read_tsv("reads_per_gene/control_rep3_ReadsPerGene.out.tab",
                           col_names = c("gene_id", "total","antisense", "sense"),
                           skip = 4)

# Control replicate 4
control_rep4 <- read_tsv("reads_per_gene/control_rep4_ReadsPerGene.out.tab",
                         col_names = c("gene_id", "total","antisense", "sense"),
                         skip = 4)

# IL4 replicate 2
IL4_rep2 <- read_tsv("reads_per_gene/IL4_rep2_ReadsPerGene.out.tab",
                         col_names = c("gene_id", "total","antisense", "sense"),
                         skip = 4)

# IL4 replicate 3
IL4_rep3 <- read_tsv("reads_per_gene/IL4_rep3_ReadsPerGene.out.tab",
                     col_names = c("gene_id", "total","antisense", "sense"),
                     skip = 4)
# IL4 replicate 4
IL4_rep4 <- read_tsv("reads_per_gene/IL4_rep4_ReadsPerGene.out.tab",
                     col_names = c("gene_id", "total","antisense", "sense"),
                     skip = 4)

# IL13 replicate 1
IL13_rep1 <- read_tsv("reads_per_gene/IL13_rep1_ReadsPerGene.out.tab",
                     col_names = c("gene_id", "total","antisense", "sense"),
                     skip = 4)

# IL13 replicate 2
IL13_rep2 <- read_tsv("reads_per_gene/IL13_rep2_ReadsPerGene.out.tab",
                      col_names = c("gene_id", "total","antisense", "sense"),
                      skip = 4)

# IL13 replicate 3
IL13_rep3 <- read_tsv("reads_per_gene/IL13_rep3_ReadsPerGene.out.tab",
                      col_names = c("gene_id", "total","antisense", "sense"),
                      skip = 4)
...
#### data wrangling --------------------------------------------
combined_data <- data.frame(row.names = control_rep1$gene_id,
                  control_rep1 = control_rep1$total,
                  control_rep3 = control_rep3$total,
